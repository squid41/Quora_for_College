...
import  {updateNotification} from '../../actions/notification.js'
...
const Comet = ()=> {
  ...
  const handleNotif=({notif})=>{
      //console.log('julllllllllll')
      let {type}=notif;console.log(type);
      notif.type="seen"
     // console.log({notif});
       ...
       <Wrapper>
              <div className="notifcard">
                  ...
                  {total && notifs.map((notif)=>{
                      ...
                      <div className="card">
                        <Avatar className="purple" alt={user} >{user?.charAt(0)}</Avatar>
                        <div className="contents">
                        <div>
                        <p>{notif.message}</p>
                      </div>
                      {notif.type==='unseen' && <BsFillCircleFill className="right"/> }
                     {notif.type==='unseen' ?handleNotif({notif}):null} 
